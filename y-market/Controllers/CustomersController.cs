...
namespace y_market.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var lstTD = db.DocumentTypes.ToList();
           // lstTD.Add(new DocumentType { DocumentTypeID = 0, Description = "[Seleccione una opción..]" });
            lstTD = lstTD.OrderBy(item => item.Description).ToList();

            ViewBag.DocumentTypeID = new SelectList(lstTD, "DocumentTypeID", "Description");
            return View();
        }
